...
**Live: [www.upforlearning.ro](https://www.upforlearning.ro)**
...
Proiectat și dezvoltat de [iWeb Digital](https://iweb-digital.ro).
...
Aplicația este live în producție la **https://www.upforlearning.ro**.

Infrastructură: **Vercel** (hosting și build) + **MongoDB Atlas** (bază de date).
Variabilele de mediu se configurează în dashboard-ul platformei de hosting — nu în
repository. `NEXT_PUBLIC_SITE_URL` trebuie setat pe `https://www.upforlearning.ro` în
mediul de producție, pentru URL-uri canonice și metadate corecte.

## Licență

Proprietar — toate drepturile rezervate. Vezi [LICENSE](LICENSE).

Copyright © 2026 Up for Learning S.R.L.

---

Proiectat și dezvoltat de **[iWeb Digital](https://iweb-digital.ro)** — vezi [AUTHORS](AUTHORS).
