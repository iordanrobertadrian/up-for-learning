...
export const metadata: Metadata = buildMetadata({
  ...
  path: ROUTES.contact,
  description:
    "Up for Learning — Str. Tudor Vladimirescu 40C, Voluntari, Ilfov. Telefon, email, program și hartă. Suntem la un mesaj distanță pentru a găsi împreună programul potrivit copilului tău.",
});
...
const contactItems: {
...
}[] = [
  {
    ...
    values: [
      {
        text: `${siteConfig.contact.address}, ${siteConfig.contact.city}, ${siteConfig.contact.county}`,
      },
    ],
  },
  {
    icon: Phone,
    label: "Telefon",
    values: siteConfig.contact.phones.map((phone) => ({
      text: phone.value,
      href: phone.href,
    })),
  },
  ...
  },
  {
    icon: Clock,
    label: "Program",
    values: [{ text: siteConfig.contact.schedule }],
  },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="Ne găsești în Voluntari, Ilfov, pe Str. Tudor Vladimirescu 40C. Ai întrebări despre programe, ateliere sau tabere? Scrie-ne, sună-ne sau programează o vizită. Îți răspundem cu drag."
