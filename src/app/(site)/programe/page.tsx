...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Înscrieri deschise în Voluntari, Ilfov: Limba română, Matematică, Clubul de după ore, Limba engleză cu pregătire pentru examenele Cambridge, Evaluări Naționale și ateliere de dezvoltare. Clasele I – VIII, 80 lei/oră, 2 ore/sesiune.",
});
