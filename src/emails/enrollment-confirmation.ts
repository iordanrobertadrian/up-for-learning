...
<html lang="ro">
  <body style="margin:0;background:#FBF7EE;font-family:'Segoe UI',Arial,sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FBF7EE;padding:32px 0;">
      <tr>
        <td align="center">
          <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px -12px rgba(57,72,49,0.16);">
            <tr>
              <td style="background:#688257;padding:26px 32px;">
            ...
            <tr>
              <td style="padding:28px 32px 8px;">
                ...
                <p style="margin:0 0 8px;font-size:15px;font-weight:600;color:#4B603E;">Echipa Up for Learning</p>
              </td>
            </tr>
            <tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid #EBDFC4;">
                  <tr>
                    <td style="padding-top:18px;">
                      ...
                      )}" style="color:#4B603E;text-decoration:none;">${esc(
